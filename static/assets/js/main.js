  ...
  e(".brand-active .col, .slider__brand-list li").on({
    ...
    e("[data-countdown]").each(function () {
      ...
      s.countdown(a, function (e) {
        s.html(
          e.strftime(
            '<div class="time-count day"><span>%D</span>روز</div><div class="time-count hour"><span>%H</span>ساعت</div><div class="time-count min"><span>%M</span>دقیقه</div><div class="time-count sec"><span>%S</span>ثانیه</div>'
          )
        );
      });
    }),
